...
Expected today: **1238 passed** (1238 collected; one of them skips where the optional
Playwright is absent, so a machine without it reads 1237 + 1), **pyright 0 errors**, **ruff clean**, **vite build OK**, **465 frontend tests**,
