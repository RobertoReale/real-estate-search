...
Expected today: **1266 passed** (1266 collected; one of them skips where the optional
Playwright is absent, so a machine without it reads 1265 + 1), **pyright 0 errors**, **ruff clean**, **vite build OK**, **465 frontend tests**,
