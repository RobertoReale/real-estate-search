...
export const en = {
  ...
  "nav.lastScan": "{new} new, {updated} updated, {filtered} filtered, {priceChanges} price changes",
  "nav.lastScanTruncated": "{count} search stopped at the page limit",
  "nav.lastScanTruncatedPlural": "{count} searches stopped at the page limit",
