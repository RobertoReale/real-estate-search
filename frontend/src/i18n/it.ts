...
export const it: Dict = {
  ...
  "nav.lastScan": "{new} nuovi, {updated} aggiornati, {filtered} filtrati, {priceChanges} cambi di prezzo",
  "nav.lastScanTruncated": "{count} ricerca si è fermata al limite di pagine",
  "nav.lastScanTruncatedPlural": "{count} ricerche si sono fermate al limite di pagine",
