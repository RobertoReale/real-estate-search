        ...
        <div className="mt-4 space-y-5">
          ...
          {empty && (
            <EmptyState className="panel rounded-xl"
              ...
              title={t("velocity.empty", { count: data?.min_sample ?? 0 })} />
          )}
          ...
          {data && data.areas.length > 0 && (
            <div>
              ...
              <div className={cx("overflow-x-auto rounded-sm", FOCUS_RING)} tabIndex={0}
                role="region" aria-label={t("velocity.areasTitle")}>
                    ...
                    {data.areas.map((a) => (
                      <tr key={`${a.scope}-${a.city}-${a.zone}`}
                        ...
                        <td className="py-2 pr-3">
                          ...
                          {a.scope === "city" ? (
                            <Chip tone="accent" className="ml-2 uppercase">
          ...
          {data && data.agencies.length > 0 && (
            <div>
              ...
              <div className={cx("overflow-x-auto rounded-sm", FOCUS_RING)} tabIndex={0}
                role="region" aria-label={t("velocity.agenciesTitle")}>
                <table className="w-full text-sm">
                  <thead className="t-muted text-xs text-left">
                    <tr className="border-b border-line">
