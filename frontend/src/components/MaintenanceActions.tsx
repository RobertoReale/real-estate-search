...
export default function MaintenanceActions() {
  ...
  return (
    // A section with a name, and not a card with a bold line at the top of it.
    // These two act on the whole collection, they sit under a list of searches
    // that act on one each, and "Find coordinates" directly below "Milano,
    // tutte le zone" reads as something that search does unless the boundary
    // between them is announced rather than merely drawn.
    <Card asChild className="space-y-3">
      <section aria-labelledby="maintenance-heading">
        <div className="flex flex-col gap-1">
          <h2 id="maintenance-heading" className="text-sm font-semibold text-ink-strong">
            {t("maintenance.title")}
          </h2>
