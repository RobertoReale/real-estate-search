...
import { Button, Card, Checkbox, Chip, Field, IconButton, Input } from "../ui";
...
export default function FiltersBar({
  ...
  return (
    ...
    <Card asChild padding="md">
      <section className="grid grid-cols-2 items-end gap-3 sm:flex sm:flex-wrap">
        ...
        <Field className="col-span-2 w-full" label={t("filters.search")}>
        ...
        {advOpen && (
          <div className="col-span-2 w-full p-3 sm:p-4 rounded-xl panel
            ...
            <Field className="col-span-2 sm:col-span-1" label={t("filters.agency")}>
              <Input data-action="filters.agency" className="sm:w-48" placeholder={t("filters.agencyPlaceholder")}
