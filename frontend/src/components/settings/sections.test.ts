...
const SAVED_KEYS = [
  ...
  "gone_after_days", "max_notifications_per_scan", "excluded_keywords",
  "match_score_enabled", "dream_max_price", "dream_min_rooms", "dream_min_sqm",
  "dream_min_floor", "dream_keywords", "dream_zones",
  "commute_enabled", "commute_points", "osrm_url", "osrm_url_foot", "osrm_url_bike",
  "nl_parser_backend", "llm_base_url", "llm_model", "listing_audit_enabled",
  "proxy_url", "proxy_urls", "scrape_api_provider", "scrape_api_mode",
  "scrape_api_monthly_credits",
...
const STORED: Settings = {
  ...
  gone_after_days: 14, max_notifications_per_scan: 25,
  ...
  osrm_url_foot: "https://routing.openstreetmap.de/routed-foot", osrm_url_bike: "",
  commute_points: [
  ...
  scrape_api_monthly_credits: 750, scrape_api_credits_per_page: 25,
  ...
  datadome_cookie_refused_at: "", datadome_cookie_refused_detail: "",
