...
export const ACTIONS = {
  ...
  "profiles.builder.zone": { what: "the builder's Zone field", does: "adds a zone to the list the search covers" },
  "profiles.builder.zoneRemove": { what: "the × on a zone chip", does: "drops that zone, by name or by portal id, from the search" },
